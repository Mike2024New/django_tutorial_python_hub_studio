...
SECRET_KEY = 'django-insecure-s1ff)*ossn$!$k54@#1y#dvib2(*@okc_n(t#6y__%o$#kjd91'
...
STATIC_URL = 'static/' # глобальный общий url адрес к статическим файлам

STATICFILES_DIRS = [
    BASE_DIR/"static" 
    ] # дополнительные пути к статическим файлам / в них django будет искать статические файлы

MEDIA_URL = 'media/' # 
MEDIA_ROOT = BASE_DIR / 'media' # подключение файлов из папки медиа
